 ...
 *
 * @lastupdate 2024-05-06 20:48:15
 */

use Diepxuan\Magento\OAuth\KeyStore\DatabaseKeyStore;
 ...
 * @author     Tran Ngoc Duc <caothu91@gmail.com>
 *
 * @lastupdate 2024-05-06 20:17:00
 */
    ...
    'connections' => [
        'default' => [
            ...
            */
            ...
            /*
            |--------------------------------------------------------------------------
            | Magento Graphql Path
            |--------------------------------------------------------------------------
            |
            |  The Magento 2 Graphql Path. By default, this
            |  is assigned as 'graphql'. Developers should only
            |  update this setting if the path has changed.
            |
            */
